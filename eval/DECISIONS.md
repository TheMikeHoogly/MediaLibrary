...
| **787 décisions humaines pointent vers des clés inconnues PARTOUT** | **MESURÉ, non expliqué** (21/08) | Ni dans l'index, ni dans le magasin de visages. Sur 3 364 décisions au total. Elles sont déjà perdues : aucun jumeau à leur chercher, aucune photo à retrouver. À rouvrir avec un chiffre neuf, pas avant. |
