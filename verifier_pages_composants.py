...
# 26/08 : `/files` (gallery) rejoint les adoptantes -- septieme page sur
# onze. Le banc l'a signale lui-meme, en grief, avant qu'on pense a le
# mettre a jour : une page non declaree qui recoit la feuille commune est
# indiscernable d'un opt-in casse. C'est le comportement voulu.
