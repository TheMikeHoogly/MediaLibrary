...
- **28/08 — un fil de travail qui meurt : le relancer, ou seulement le DIRE ?**
  **Tranché par Mike : le RELANCER, et ALERTER à cinq erreurs consécutives.**
  Détail et risques dans `docs/DECISIONS_OUTILLAGE.md` (Pilotage du serveur).
  Reste à écrire — c'est le point 1 ter du `ROADMAP.md`.
