...
>
> **Vidée le 22/09** : les deux questions de la brique 1. Mike : **« je suis
> tes recommandations »** → **(a) la file de revue**, et donc **PAS** les trois
> champs au passage de la vignette (ils n'avaient de sens que pour (b), le
> modèle dédié). Livré le jour même : trois familles dans l'onglet Sensibles,
> aucune photo masquée automatiquement. Verdict dans `eval/DECISIONS.md`.
>
